...
CRingBuffer::CRingBuffer()
{
	...
	InitializeSRWLock(&hSrwRingBuffer);
...
void CRingBuffer::SrwExcluciveLock()
{
	AcquireSRWLockExclusive(&hSrwRingBuffer);
}

void CRingBuffer::SrwExcluciveRelease()
{
	ReleaseSRWLockExclusive(&hSrwRingBuffer);
}

void CRingBuffer::SrwShareLock()
{
	AcquireSRWLockShared(&hSrwRingBuffer);
}

void CRingBuffer::SrwScharRelease()
{
	ReleaseSRWLockShared(&hSrwRingBuffer);
}
